...
import 'package:spotrootpartner/controllers/NavigationServce.dart';
...
class ImagePickerController extends GetxController {
  ...
  set addSelectedMediaList(v) {
    _selectedMediaList.add(v);
    update();
  }

  set remoevSelectedMediaList(v) {
    _selectedMediaList.remove(v);
    update();
  }
